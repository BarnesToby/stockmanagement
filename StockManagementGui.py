...
# programm:			StockManagementGui.py
# author:			Toby Barnes
...
# title of class: 	GuiWindow
# This class sets up the main window attributes for the GUI.
class GuiWindow(QtGui.QMainWindow):
	...
	destructor = self.__del__
	gui_content = GuiWidget(popup_pointer, destructor)
...
# GuiWidget(popup_function, destructor)
# - popup_function: 	pass a pointer that points at a pop-up creating function
# - destructor:			pass a pointer that points at the destructor of the main window
...
class GuiWidget(QtGui.QWidget):
	...
	# The buttons that open a pop-up or shuts the program down 
	...
	# the buttons that navigate threw the material list is defined 
	# and set into the layout
	...
	# this function when called, makes a refresh of the current material 
