...
# title of function: 	getreducedcsvlist()
...
# title of function: 	changepage(number)
...
# title of function: 	addlistcsv(attendlist)
...
# title of function: 	writelistcsv(writelist)
...
# title of function: 	sortcsv(sortnum)
...
# title of function: 	changematerialcount(artikelnummer, lieferant, anzahl, modus, errorpopup)
